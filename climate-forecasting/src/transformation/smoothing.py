...
class Smoothing:
  ...
  def persistence_regressor(self, data: pd.DataFrame, size: str):
    ...
    self.plot_forecasting_series(train, prd_trn, f'climate-forecasting/records/transformation/smoothing/smoothing_persistence_plots_{size}.png', f'{size} days', y_label='QV2M')
