...
class ARIMA:
    ...
    def explore_arima(self, test: pd.DataFrame) -> None:
        ...
        savefig(f'climate-forecasting/records/evaluation/arima_study.png')
        ...
        plot_evaluation_results(self.data.values, prd_trn, test.values, prd_tst, f'climate-forecasting/records/evaluation/arima_eval')
        self.plot_forecasting_series(self.data, test, prd_trn, prd_tst, f'climate-forecasting/records/evaluation/arima_plots.png', "Arima plot", x_label='date', y_label='QV2M')
