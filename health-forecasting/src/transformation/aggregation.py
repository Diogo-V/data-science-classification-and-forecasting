...
class Aggregation:
    ...
    def plot_forecasting_series(self, trn, prd_trn, file_path: str, tittle: str, x_label: str = 'time', y_label:str =''):
    ...
    def persistance(self, data: pd.DataFrame, approach: str) -> None:
        ...
        self.plot_forecasting_series(train, prd_trn, f'health-forecasting/records/transformation/aggregation/aggregation_{approach}_{measure}_persistance_plots.png', approach,  x_label="Date", y_label="Glucose")
