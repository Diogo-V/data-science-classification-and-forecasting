...
class Differentiation:
  ...
  def plot_figure(self, data: pd.DataFrame, title: str) -> None:
    ...
    xticks(rotation = 45)
    savefig(f'health-forecasting/records/transformation/differentiation/differentiation_{title}_plot.png')
  ...
  def simple_average(self, data: pd.DataFrame, approach: str):
      ...
      plt.savefig(f'health-forecasting/records/transformation/differentiation/differentiation_{approach}_{measure}_simple_avg_eval.png')
      ...
      plt.savefig(f'health-forecasting/records/transformation/differentiation/differentiation_{approach}_{measure}_simple_avg_plots.png')
