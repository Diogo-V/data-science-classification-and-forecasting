...
class Differentiation:
  ...
  def plot_figure(self, data: pd.DataFrame, approach: str, title: str) -> None:
    ...
    xticks(rotation = 45)
    savefig(f'health-forecasting/records/transformation/differentiation/differentiation_{approach}_plot.png')
  ...
  def persistance(self, data: pd.DataFrame, approach: str, tittle: str) -> None:
      ...
      plot_evaluation_results(train.values, prd_trn, test.values, prd_tst, tittle, f'health-forecasting/records/transformation/differentiation/differentiation_{approach}_{measure}_persistance_eval')
      self.plot_forecasting_series(train, test, prd_trn, prd_tst, f'health-forecasting/records/transformation/differentiation/differentiation_{approach}_{measure}_persistance_plots.png', tittle=tittle, x_label="Date", y_label="Glucose")
  ...
  def simple_average(self, data: pd.DataFrame, approach: str):
      ...
      self.plot_forecasting_series(train, test, prd_trn, prd_tst, f'health-forecasting/records/transformation/differentiation/differentiation_{approach}_{measure}_simple_avg_plots', x_label="date", y_label="Glucose")
