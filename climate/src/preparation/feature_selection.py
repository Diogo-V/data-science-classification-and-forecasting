...
class FeatureSelection:
    ...
    def explore_redundat(self): 
        ...
        savefig(f'climate/records/preparation/filtered_correlation_analysis_{self.threshold}.png')
    ...
    def select_low_variance(self, data: pd.DataFrame):
        numeric_vars = ['fips', 'PRECTOT', 'PS', 'QV2M', 'T2M_MAX', 'T2M_RANGE', 'WS10M', 'WS10M_MIN', 'WS10M_RANGE', 'WS50M_MAX', 'WS50M_RANGE', 'lat', 'elevation', 'slope1', 'slope2', 'slope3', 'slope4', 'slope5', 'slope7', 'aspectN', 'aspectW', 'WAT_LAND', 'NVG_LAND', 'URB_LAND', 'GRS_LAND', 'CULTIR_LAND']
        ...
        savefig('climate/records/preparation/filtered_variance_analysis.png')
