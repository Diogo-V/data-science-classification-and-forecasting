...
class GradientClassifier:
    ...
    def explore_best_gradient(self):
        ...
        savefig(f'climate/records/evaluation/gradient_boosting_study.png')
        print('Best results with depth=%d, learning rate=%1.2f and %d estimators, with accuracy=%1.2f'%(best[0], best[1], best[2], last_best))
        f= open('climate/records/evaluation/gb_best_details.txt', 'w')
    ...
    def compute_best_gradient(self, max_depth, lr, estimators):
        ...
        savefig(f'climate/records/evaluation/gb_best_results.png')
        ...
        savefig(f'climate/records/evaluation/gb_best_feature_rankings.png')
