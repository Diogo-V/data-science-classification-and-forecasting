...
from ds_charts import plot_evaluation_results_train_test_matrixes, multiple_line_chart, horizontal_bar_chart, HEIGHT, plot_overfitting_study
...
class RTClassifier:
  ...
  def explore_best_rt(self):
    ...
    f= open('climate/records/evaluation/rf_best_details.txt', 'w')
  ...
  def compute_best_rt_results(self, depth, features, estimators):
    ...
    savefig(f'climate/records/evaluation/rf_best_results.png')

    # Then, plot features importance
    variables = self.train_data.columns + 'class'
