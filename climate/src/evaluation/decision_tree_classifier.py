...
from ds_charts import multiple_line_chart, plot_evaluation_results_train_test_matrixes, horizontal_bar_chart, plot_overfitting_study
...
class DTClassifier:
  ...
  def __init__(self, data_train: DataFrame, data_test: DataFrame) -> None:
    ...
    self.min_impurity_decrease = [0.0005, 0.00025, 0.000125, 0.00005, 0.000025]
  ...
  def compute_best_dt(self):
    ...
    savefig(f'climate/records/evaluation/dt_study.png')
  ...
  def explore_dt_best_matrix_results(self, depth: int, criteria: str, impurity: int):
    ...
    plot_evaluation_results_train_test_matrixes(labels, self.trnY, prd_trn, self.tstY, prd_tst)
    savefig('climate/records/evaluation/dt_depth_impurity_best_results.png')

    f= open('climate/records/evaluation/dt_depth_impurity_best_results_details.txt', 'w')
  ...
  def explore_dt_feature_importance(self):
    ...
    savefig(f'climate/records/evaluation/dt_feature_ranking.png')
  ...
  def explore_best_dt_overfit(self, criteria: str, impurity: int):
    ...
    def plot_overfitting_study(t, xvalues, prd_trn, prd_tst, name, xlabel, ylabel, pct=True):
      ...
      savefig(f'climate/records/evaluation/dt_overfitting_exploration_{t}.png')
    ...
    for d in self.max_depths:
        ...
        y_test_values_f1.append(f1_score(self.tstY, prd_tst_Y))
        y_train_values_f1.append(f1_score(self.trnY, prd_trn_Y))
